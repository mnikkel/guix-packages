  ...
  (package
    ...
    (source
      (origin
        ...
        (file-name (string-append name "-" version ".tar.gz"))
        (sha256
          (base32 "0npgsl9h1wqlhvw23dspzw343mbykggq9wznbjavch2s1szvk9hp"))))
    (build-system cargo-build-system)
    (arguments
      `(#:skip-build?
        #t
  ...
  (package
    ...
    (source
      (origin
        ...
        (file-name (string-append name "-" version ".tar.gz"))
        (sha256
          (base32 "1vphysahrh16nj4k3ldw9qqjqjcada7pzj5bfq62nlfhif7za6lr"))))
    (build-system cargo-build-system)
    (arguments `(#:skip-build? #t))
    (home-page "https://github.com/Canop/strict")
    (synopsis "NonEmptyVec, a vec guaranteed to hold at least one element")
    (description "NonEmptyVec, a vec guaranteed to hold at least one element")
    (license license:expat)))
  ...
  (package
    ...
    (source
      (origin
        ...
        (file-name (string-append name "-" version ".tar.gz"))
        (sha256
          (base32 "107ffm63gbpizpc9v0cm8kzm2kgcmhygfdam0af0w26li672k441"))))
    (build-system cargo-build-system)
    (arguments `(#:skip-build? #t))
    (home-page "https://github.com/Canop/splitty")
    (synopsis "a string splitter taking quotes into account")
  ...
  (package
    ...
    (source
      (origin
        ...
        (file-name (string-append name "-" version ".tar.gz"))
        (sha256
          (base32 "1v9h8vpajqlwhazmlvcyifk5lzwazs4v2kfgkdllwamqxi0g4mw9"))))
    (build-system cargo-build-system)
    (arguments
      `(#:skip-build?
        #t
    ...
    (arguments
      `(#:skip-build?
        ...
        (("rust-bytemuck" ,rust-bytemuck-1)
         ...
         ("rust-dcv-color-primitives" ,rust-dcv-color-primitives-0.1)
  ...
  (package
    ...
    (source
      (origin
        ...
        (file-name (string-append name "-" version ".tar.gz"))
        (sha256
          (base32 "1x93mash0z43li7k5mam4pqbjvlb6m5mldrn8wvgkk9y3zsnyj0z"))))
    (build-system cargo-build-system)
    (arguments
  ...
  (package
    ...
    (source
      (origin
        ...
        (file-name (string-append name "-" version ".tar.gz"))
        (sha256
          (base32 "19mwa90z1hgwn3mqj07b4cy6j4yc8c59k2n99mdvm9kz37fm32jg"))))
    (build-system cargo-build-system)
    (arguments `(#:skip-build? #t))
    (home-page "https://github.com/lovasoa/custom_error")
    (synopsis
...
(define-public rust-char-reader-0.1
  (package
    ...
    (synopsis "Safely read wild streams as chars or lines")
  ...
  (package
    ...
    (source
      (origin
        ...
        (file-name (string-append name "-" version ".tar.gz"))
        (sha256
          (base32 "0w46dpfdhwrr90qvqi3nli46gxfalhic49vxbrchpysqfrc8w89y"))))
    (build-system cargo-build-system)
    (arguments `(#:skip-build? #t))
    (home-page "https://github.com/Canop/bet")
    (synopsis "Helps parsing and evaluating binary expression trees")
...
(define-public rust-broot-1
  (package
    ...
    (description "This package provides a new file manager")
    (license license:expat)))
